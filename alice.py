...
def main():
    ...
    minute_close = []
    access_token =  AliceBlue.login_and_get_access_token(username=username, password=password, twoFA=twoFA,  api_secret=api_secret,redirect_url='http://127.0.0.1/')
    alice = AliceBlue(username=username, password=password, access_token='fEQ-VRtN8ibefUhIbrpBkBtT_2tbKBrzmRJFk4koPso.EiIchJGNhDlprD7Gnq6EuLTBBBC1yF4CKaF2ibFXR6Q', master_contracts_to_download=['NSE'])
